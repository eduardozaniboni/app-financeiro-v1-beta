...
export default function Planejamento() {
    ...
    const totalContributed =
        parseFloat(simulation.initialAmount) + parseFloat(simulation.monthlyContribution) * parseInt(simulation.period);
    ...
    return (
        <div className='space-y-8'>
            ...
            <div>
                ...
                <p className='text-muted-foreground'>Simule o crescimento do seu patrimônio com aportes regulares</p>
            </div>
                        ...
                        <CardContent className='space-y-6'>
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setSimulation((prev) => ({ ...prev, initialAmount: e.target.value }))
                                    }
                                    placeholder='10.000'
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setSimulation((prev) => ({ ...prev, monthlyContribution: e.target.value }))
                                    }
                                    placeholder='1.000'
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setSimulation((prev) => ({ ...prev, expectedReturn: e.target.value }))
                                    }
                                    placeholder='10.5'
                                />
                            </div>
                            ...
                            <div className='space-y-2'>
                                <Button onClick={saveInvestment} className='w-full bg-gradient-primary'>
                                    Salvar Planejamento
                                </Button>
                    ...
                    <Card className='shadow-soft mt-6'>
                        ...
                        <CardContent className='space-y-3'>
                            <div className='flex justify-between text-sm'>
                                <span className='text-muted-foreground'>CDI (2025):</span>
                            ...
                            <div className='flex justify-between text-sm'>
                                <span className='text-muted-foreground'>IPCA (Média):</span>
                            ...
                            <CardContent className='p-4'>
                                <div className='text-center'>
                                    ...
                                    <p className='text-xl font-bold text-success'>
                                        {finalValue.nominal.toLocaleString('pt-BR', {
                                            style: 'currency',
                                            currency: 'BRL',
                                        })}
                                    </p>
                        ...
                        <Card className='shadow-soft'>
                            <CardContent className='p-4'>
                                <div className='text-center'>
                                    ...
                                    <p className='text-xl font-bold text-success'>{returnPercentage.toFixed(1)}%</p>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
                        ...
                        <CardContent>
                            <SimpleChart
                                data={projectionData.filter(
                                    (_, index) => index % Math.ceil(projectionData.length / 20) === 0
                                )}
                                type='area'
                                height={400}
                                dataKey='nominal'
                                ...
                                <table className='w-full text-sm'>
                                    ...
                                    <tbody>
                                        {projectionData
                                            ...
                                            .map((item, index) => {
                                                const contribution =
                                                    parseFloat(simulation.initialAmount) +
                                                    parseFloat(simulation.monthlyContribution) * item.month;
                                                const earnings = item.nominal - contribution;
                                                return (
                                                    <tr key={index} className='border-b border-border/50'>
                                                        <td className='p-2'>{item.month} meses</td>
                                                        <td className='text-right p-2 font-medium'>
                                                            {item.nominal.toLocaleString('pt-BR', {
                                                                style: 'currency',
                                                                currency: 'BRL',
                                                            })}
                                                        </td>
                            ...
                            {investments.map((investment) => (
                                ...
                                >
                                    ...
                                    <div className='space-y-1 text-sm text-muted-foreground'>
                                        <p>
                                            Inicial:{' '}
                                            {investment.initialAmount.toLocaleString('pt-BR', {
                                                style: 'currency',
                                                currency: 'BRL',
                                            })}
                                        </p>
                                        <p>
                                            Mensal:{' '}
                                            {investment.monthlyContribution.toLocaleString('pt-BR', {
                                                style: 'currency',
                                                currency: 'BRL',
                                            })}
                                        </p>
